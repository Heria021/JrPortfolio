...
export default function AdminProjectEditPage({ className = "" }: AdminProjectEditPageProps) {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center space-y-4">
          <div className="w-8 h-8 animate-spin rounded-full border-2 border-transparent border-t-primary mx-auto" />
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Update project details and manage images</p>
              </div>
            </div>
            <Link href="/admin">
              <Button variant="outline" className="rounded-lg">
...
const ProjectEditForm = React.memo<ProjectEditFormProps>(({
  onSubmit,
  onImagesChange,
  form,
  isSubmitting,
    ...
    <div className={cn("h-full border rounded-xl flex flex-col overflow-hidden", className)}>
      ...
      <div className="flex-shrink-0 p-4 border-b border-border/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base font-semibold text-foreground">Edit Project Details</h3>
            <p className="text-xs text-muted-foreground">
              Update project information and manage images
            </p>
          </div>
        </div>
      </div>
            ...
            <ScrollArea className="flex-1 overflow-hidden">
              <div className="p-6 space-y-8">
                ...
                <FormSection 
                  ...
                  icon={ImageIcon}
                  description="Manage your project photos"
                >
                  <FormField
                    control={form.control}
                    name="images"
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Click images to reorder them. First image will be used as the cover.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
...
const ImageManager = React.memo<ImageManagerProps>(({
  images,
  onImagesChange,
  className = "",
}) => {
  ...
  if (images.length === 0) {
    return (
      <div className={cn("p-8 border-2 border-dashed border-muted-foreground/25 rounded-xl text-center", className)}>
        <div className="space-y-4">
          <div className="w-16 h-16 mx-auto rounded-full bg-muted flex items-center justify-center">
            <ImageIcon className="w-8 h-8 text-muted-foreground" />
          </div>
          <div>
            <h4 className="font-medium text-foreground">No images uploaded</h4>
  ...
  return (
    <div className={cn("space-y-6", className)}>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h4 className="font-medium text-sm">Project Images</h4>
          <p className="text-xs text-muted-foreground">
